							...
							<div class="container">
								<div class="row">
									<form class="form-signin mg-btm">
										<h3 class="heading-desc">Forgot Password</h3>
										<div class="main">
											Enter Registered Email ID <input type="text"
												class="form-control" placeholder="Email" autofocus>
											Are you a business? <a href="pg-owner-register.html"
											...
											<div class="row">
												<div class="col-xs-6 col-md-6">
													<div class="left-section">
														<a href="user-register.html">Sign Up</a> <a
															href="user-login.html">Sign In</a>
													</div>
												</div>
												<div class="col-xs-6 col-md-6 pull-right">
													<button type="submit"
														class="btn btn-large btn-danger pull-right">Submit</button>
												</div>
											</div>
