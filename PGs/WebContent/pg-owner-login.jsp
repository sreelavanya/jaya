					...
					<div class="box-widget">
						<div class="panel-default">
							<div class="widget-block-title">
								...
								<h3 style="margin: 4% 1px;">Login to PG Owner</h3>
								...
								<form class="form-common">
									...
									<div class="form-group row form-check-row">
										...
										<div class="col-md-6">
											<div class="forgot-link-block">
												<a href="pg-owner-forget-password.html" class="forgot-link">Forget
													Password?</a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="forgot-link-block"
											...
											<a href="pg-owner-register.html" class="forgot-link">Sign
												In Here</a>
										</div>
									</div>
								</form>
